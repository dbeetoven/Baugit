/*! For license information please see 8.9d2fb58e.chunk.js.LICENSE.txt */
(this.webpackJsonpbaugit = this.webpackJsonpbaugit || []).push([
  [8],
  {
    66: function (e, t, n) {
      ...
      var _,
        g = new c.Logger('@firebase/analytics');
      function f(e, t, n) {
        var i = function () {
        ...
        return (
          window[n] && 'function' === typeof window[n] && (i = window[n]),
          (window[n] = (function (e, t) {
            return function (n, i, a) {
              if (n === r.EVENT) {
                ...
                if (0 === o.length)
                  for (var _ = 0, f = Object.values(t); _ < f.length; _++) {
                    var E = f[_];
                    o.push(E);
                  }
                Promise.all(o)
                  .then(function () {
                    return e(r.EVENT, i, a || {});
                  })
                  .catch(function (e) {
                    return g.error(e);
                  });
          ...
          { gtagCore: i, wrappedGtag: window[n] }
        );
      }
      var E,
        p,
        m =
          (((_ = {})['no-ga-id'] =
            '"measurementId" field is empty in Firebase config. Firebase Analytics requires this field to contain a valid measurement ID.'),
          (_['already-exists'] =
          ...
          (_['interop-component-reg-failed'] =
            'Firebase Analytics Interop Component failed to instantiate'),
          _),
        w = new u.ErrorFactory('analytics', 'Analytics', m),
        I = {},
        v = 'dataLayer',
        h = 'gtag',
        T = !1;
      function N(e) {
        if (T) throw w.create('already-initialized');
        e.dataLayerName && (v = e.dataLayerName), e.gtagName && (h = e.gtagName);
      }
      function y(e, t) {
        var n = e.options.measurementId;
        if (!n) throw w.create('no-ga-id');
        if (null != I[n]) throw w.create('already-exists', { id: n });
        if (!T) {
          (function () {
            for (
              var e = window.document.getElementsByTagName('script'), t = 0, n = Object.values(e);
              t < n.length;
              t++
            ) {
              var r = n[t];
              if (r.src && r.src.includes(d)) return r;
            }
            return null;
          })() ||
            (function (e) {
              var t = document.createElement('script');
              (t.src = d + '?l=' + e), (t.async = !0), document.head.appendChild(t);
            })(v),
            (function (e) {
              var t = [];
                  ...
                  case 1:
                    return (
                      ...
                      n(
                        ...
                        (((a = {}).firebase_id = i), (a.origin = 'firebase'), (a.update = !0), a),
                      ),
                      [2]
                    );
                }
          ...
          })(e, t, E)),
          {
            ...
            logEvent: function (e, t, i) {
              return (function (e, t, n, i, a) {
                var o = i || {};
                (a && a.global) ||
                  (o = Object(s.__assign)(Object(s.__assign)({}, i), { send_to: t })),
                  e(r.EVENT, n, o || {});
              })(p, n, e, t, i);
            },
            setCurrentScreen: function (e, t) {
              return (function (e, t, n, i) {
                i && i.global
                  ? e(r.SET, { screen_name: n })
                  : e(r.CONFIG, t, { update: !0, screen_name: n });
              })(p, n, e, t);
            },
            setUserId: function (e, t) {
              return (function (e, t, n, i) {
                i && i.global
                  ? e(r.SET, { user_id: n })
                  : e(r.CONFIG, t, { update: !0, user_id: n });
              })(p, n, e, t);
            },
            setUserProperties: function (e, t) {
              return (function (e, t, n, i) {
                if (i && i.global) {
                  for (var a = {}, o = 0, s = Object.keys(n); o < s.length; o++) {
                    var c = s[o];
                    a['user_properties.' + c] = n[c];
                  }
                  e(r.SET, a);
                } else e(r.CONFIG, t, { update: !0, user_properties: n });
              })(p, n, e, t);
            },
      ...
      var C;
      (C = o.a).INTERNAL.registerComponent(
        new l.Component(
          'analytics',
          function (e) {
            return y(
          ...
          'PUBLIC',
        ).setServiceProps({ settings: N, EventName: i }),
      ),
        C.INTERNAL.registerComponent(
          new l.Component(
            'analytics-internal',
            function (e) {
              try {
                ...
                throw w.create('interop-component-reg-failed', { reason: t });
              }
            },
            'PRIVATE',
          ),
        ),
        C.registerVersion('@firebase/analytics', '0.3.0');
    },
  },
]);
//# sourceMappingURL=8.9d2fb58e.chunk.js.map
